        ...
        <div class="container"><a class="navbar-brand logo" href="#"><img id="logo" src="assets/img/js.svg"></a><button
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                <li class="nav-item" role="presentation"><a class="nav-link " href="index.php">Home</a></li>
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="unos.php">Contact Us</a></li>
        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">Administracija</h2>
                </div>
            </div>
                ...
                <div class="col-md-12 col-xl-12 offset-md-0 offset-xl-0 col-12 col-lg-12">
                    <div class="row border-roza">
                        <div class="col col-12 p-1">
                            <form class="tablica" method="post" action="skripta.php" name="unos"
                                enctype="multipart/form-data">
                                <div class="form-row">
                                    <div class="col col-lg-1"><label class="col-form-label">Ime vijesti</label></div>
                                    <div class="col col-lg-2"><label class="col-form-label">Kratki sažetak
                                            vijesti</label></div>
                        ...
                        if ((isset($_SESSION['username'])) && $_SESSION['level'] == 1) {
                            ...
                            while($row = mysqli_fetch_array($result)) {
                                        echo '<div class="col col-12 gotovo p-1">
                                                <form class="tablica" method="post" name="unos" enctype="multipart/form-data">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col col-1">
                                                            <div class="form-group">
                                                                ...
                                                                if($row['do_show'] == 0) {
                                                                    ...
                                                                    <label class="form-check-label custom-control-label noshowmob" for="customCheck1">Da</label></div>';
                                                                    } else {
                                                        ...
                                                        <input type="hidden" name="id" class="form-field-textual"
                                                                value="'.$row['id'].'">
                                                        <div class="col col-1">
                                                            <button class="btn uredi" type="submit" name="update"><i class="far fa-check-circle"></i></button><br>
                                                            <button class="btn uredi" type="reset" value="reset"><i class="fas fa-undo"></i></button><br>
                                                            <button class="btn uredi" type="submit" name="delete"><a class="delete" href="administracija.php?delete=' . $row['id'] . '"><i class="far fa-trash-alt"></i></a></button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>';
                                            ...
                                            echo '<h4>Bok ' . $_SESSION['username'] . '! Uspješno ste prijavljeni, ali niste administrator.</h4>';
                                            echo '</div>';
                                        } else {
                                            echo '<div class="container">';
                                            echo '<h4>Niste prijavljeni. </h4><br/>';
                                            echo '<h4>Prijavite se <a href="login.php">OVDJE</a>, ili se registrirajte <a href="registration.php">OVDJE</a>.</h4>';
                                            echo '</div>';
                                        }
                                        ?>
                    </div>
