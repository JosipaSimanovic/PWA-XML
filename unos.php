...
<?php
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3 offset-xl-3">
                    ...
                    <form action="skripta.php" method="post" name="unos" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Prikaži obavijest na stranici</label>
                            <div class="form-check custom-control custom-checkbox">
                                <input class="form-check-input custom-control-input" 
                                    type="checkbox" 
                                    id="customCheck1"
                                    name="show">
                                <label class="form-check-label custom-control-label"for="customCheck1">Prikaži</label>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        slanjeForme = false;
        poljeTitle.style.border="1px solid #ff9b94";
        ...
        slanjeForme = false;
        poljeAbout.style.border="1px solid #ff9b94";
        ...
        if (content.length == 0) {
        slanjeForme = false;
        poljeContent.style.border="1px solid #ff9b94";
       ...
       10
        ...
        if (pphoto.length == 0) {
        slanjeForme = false;
        poljeSlika.style.border="1px solid #ff9b94";
        ...
        slanjeForme = false;
        poljeCategory.style.border="1px solid #ff9b94";
